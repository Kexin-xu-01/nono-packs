...
With this pack installed, Claude Code is more reliable inside `nono`:

- it understands sandbox denials as hard security boundaries
- it can inspect the active capability file
- it points users at `nono why` for exact diagnostics
- it recommends capability/profile fixes instead of unsafe workarounds
